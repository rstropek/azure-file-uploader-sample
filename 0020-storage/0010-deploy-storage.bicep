...
var storageName = concat('stg', uniqueString(rgName))
...
resource csvStorage 'Microsoft.Storage/storageAccounts@2021-02-01' = {
  ...
  sku: {
    ...
    tier: 'Premium'       // See also https://azure.microsoft.com/en-us/pricing/details/storage/blobs/
  }
