...
param poolName string = 'sqlpool-${uniqueString(baseName)}'
param poolCapacity int = 50
...
resource pool 'Microsoft.Sql/servers/elasticPools@2020-11-01-preview' = {
  location: location
  name: '${server.name}/${poolName}'
  sku: {
    name: 'StandardPool'
    tier: 'Standard'
